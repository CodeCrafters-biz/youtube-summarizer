<script>
	...
	const { form, errors, enhance, delayed } = superForm(data.form, {
		taintedMessage: null,
		validators: zod(referenceSchema),
		delayMs: 0
	});
...
<div class="container">
	<h1 class="text-3xl font-semibold mb-2">Edit reference</h1>
	<Card.Root class="w-full mb-4">
		<Card.Header>
			<Card.Title>Edit project reference</Card.Title>
			<Card.Description>ID: {$form.id}</Card.Description>
		</Card.Header>
		<Card.Content>
