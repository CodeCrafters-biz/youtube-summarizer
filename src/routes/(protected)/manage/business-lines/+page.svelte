		...
		},
		{
			...
			cell: (item) => {
				return createRender(Actions, {
					id: item.value,
					onEdit: () => {
						const entity = data.businessLines.find((entity) => entity.id === item.value);
						editObj = {
							id: item.value,
...
<form
	...
	method="post"
>
	<Button type='submit' variant="ghost" size="sm" class="mr-2">load</Button>
</form>

<DataTable
	data={data.businessLines}
	columnsData={columns}
...
<Dialog.Root bind:open={editOpen}>
	<Dialog.Content class="sm:max-w-[425px]">
		<Dialog.Header>
			<Dialog.Title>Edit business line</Dialog.Title>
			<Dialog.Description>
...
<Dialog.Root bind:open={deleteOpen}>
	<Dialog.Content class="sm:max-w-[425px]">
		<Dialog.Header>
			<Dialog.Title>Delete business line</Dialog.Title>
			<Dialog.Description>
...
<Dialog.Root bind:open={bulkDeleteOpen}>
	<Dialog.Content class="sm:max-w-[425px]">
		<Dialog.Header>
			<Dialog.Title>Delete business lines</Dialog.Title>
			<Dialog.Description>
...
<Dialog.Root bind:open={addOpen}>
	<Dialog.Content class="sm:max-w-[425px]">
		<Dialog.Header>
			<Dialog.Title>Create new business line</Dialog.Title>
			<Dialog.Description>Fill in information about new business line</Dialog.Description>
		</Dialog.Header>
